  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        a: "サブスクの金額を変更すると価格改定の履歴が自動で記録され、値上げは一覧でひと目でわかります。無料体験（トライアル）の終了日を設定しておくと、終了が近づいたときに通知でお知らせします。",
      },
      {
        q: "貯金は自動で積み立てられますか？",
      ...
      {
        q: "予算の使いすぎを知らせてくれますか？",
        a: "カテゴリや全体の予算が80%・100%に達すると通知でお知らせします。予算を決めるときは、過去3ヶ月の平均から金額を提案します（プラス以上の機能です）。",
      },
      {
        q: "たくさんの取引をまとめて整理できますか？",
