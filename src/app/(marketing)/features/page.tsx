...
const SECTIONS: {
...
}[] = [
  {
    icon: CalendarIcon,
    tag: "カレンダー表示",
    title: "1か月のお金を、カレンダーで。",
    body: "収支をカレンダーの形で一覧。どの日にいくら使ったかが、めくるだけでひと目で分かります。日付を選択するとその日の明細が開き、その日づけのまま記録を追加いただけます。",
  },
  {
    icon: ChartIcon,
    tag: "8つの切り口の分析",
  ...
  },
  {
    ...
    tag: "自動化・繰り返し",
    title: "決まった出入りは、自動で。",
    body: "家賃やサブスクの引き落としを「定期取引」に登録すれば、毎月・毎週など自動で家計簿に記録。貯金も毎月の自動積立で少しずつ積み上がります。記録の手間を、限りなく小さく。",
  },
  {
    icon: ClockIcon,
    tag: "コストタイム",
  ...
  },
  {
    ...
    tag: "サブスク・レビュー",
    title: "1件ずつ、心地よく仕分け。",
    body: "登録中のサブスクを大きなカードで1つずつ提示。「必要」か「見直す」かを一度の操作で選択いただけます。最後に年間の節約候補額をお知らせします。",
    tier: "PRO",
  },
  {
    icon: UsersIcon,
    tag: "ファミリー共有",
    title: "家族のサブスクを、すべて把握。",
    body: "家族で1つの共有帳簿を持ち、誰が・何に・いくら払っているかを一覧で。重複契約や負担の偏りにも、すぐに気づいていただけます。",
    tier: "PLUS",
  },
];
...
const MORE = [
  ...
  { icon: SlidersIcon, title: "一括編集", body: "複数の取引をまとめて選択し、カテゴリ・支払い方法の変更や削除を一度の操作で。" },
  { icon: ArrowUpIcon, title: "値上げ検知", body: "サブスクの金額が変わると価格改定を自動で記録。値上げは一覧でひと目で分かります。" },
  ...
  { icon: CalendarIcon, title: "カレンダー / 一覧", body: "同じ家計簿を、カレンダーと一覧のどちらでも。用途に合わせて一度の操作で切り替えられます。" },
  { icon: ChartIcon, title: "分析・レポート", body: "支出・収入・収支・年間・貯蓄・貯蓄率・予算の8タブ。合計や前月比つきの美しいグラフで。" },
  { icon: SparklesIcon, title: "スマート解約アシスト", body: "主要40以上のサービスに対応。解約ページへ最短で移動でき、手順もその場でご確認いただけます。" },
