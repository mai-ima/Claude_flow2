  ...
  return (
    <div className="inline-flex items-center gap-1 rounded-xl border border-border-subtle bg-surface-1 p-1">
      <button
        onClick={() => go(-1)}
        aria-label="前の月"
        className="grid h-11 w-11 place-items-center rounded-lg text-text-secondary hover:bg-surface-2"
      >
      ...
      <button
        ...
        aria-label="次の月"
        disabled={isCurrent}
        className="grid h-11 w-11 place-items-center rounded-lg text-text-secondary hover:bg-surface-2 disabled:opacity-30 disabled:hover:bg-transparent"
      >
