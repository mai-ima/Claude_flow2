...
CREATE TABLE "User" (
    ...
    "betaOptIn" BOOLEAN NOT NULL DEFAULT false,
...
CREATE TABLE "Goal" (
    ...
    "autoContributionAmount" INTEGER,
    "autoContributionDay" INTEGER,
    "nextAutoContributionAt" TIMESTAMP(3),
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
...
-- CreateIndex
CREATE INDEX "RecurringTransaction_ledgerId_active_idx" ON "RecurringTransaction"("ledgerId", "active");

-- CreateIndex
CREATE INDEX "RecurringTransaction_nextRunAt_idx" ON "RecurringTransaction"("nextRunAt");
...
-- CreateIndex
CREATE INDEX "SubscriptionPriceChange_subscriptionId_changedAt_idx" ON "SubscriptionPriceChange"("subscriptionId", "changedAt");

-- CreateIndex
CREATE INDEX "Goal_ledgerId_idx" ON "Goal"("ledgerId");

-- CreateIndex
CREATE INDEX "Goal_nextAutoContributionAt_idx" ON "Goal"("nextAutoContributionAt");
...
-- AddForeignKey
ALTER TABLE "RecurringTransaction" ADD CONSTRAINT "RecurringTransaction_ledgerId_fkey" FOREIGN KEY ("ledgerId") REFERENCES "Ledger"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "RecurringTransaction" ADD CONSTRAINT "RecurringTransaction_createdByUserId_fkey" FOREIGN KEY ("createdByUserId") REFERENCES "User"("id") ON DELETE CASCADE ON UPDATE CASCADE;
